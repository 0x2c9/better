<template>
	...
	>
		<defs>
			<symbol id="material-symbols-home-outline-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
					d="M6 19h3v-5q0-.425.288-.712T10 13h4q.425 0 .713.288T15 14v5h3v-9l-6-4.5L6 10zm-2 0v-9q0-.475.213-.9t.587-.7l6-4.5q.525-.4 1.2-.4t1.2.4l6 4.5q.375.275.588.7T20 10v9q0 .825-.588 1.413T18 21h-4q-.425 0-.712-.288T13 20v-5h-2v5q0 .425-.288.713T10 21H6q-.825 0-1.412-.587T4 19m8-6.75"
				/>
			</symbol>
			<symbol id="material-symbols-home-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-today-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-monitor-weight" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-monitor-weight-outline" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-settings-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-settings-outline-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-visibility-outline-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-visibility-off-outline-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-exercise" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-exercise-outline" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-check-circle-outline-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-check-circle-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
					d="m10.6 13.8l-2.15-2.15q-.275-.275-.7-.275t-.7.275q-.275.275-.275.7t.275.7L9.9 15.9q.3.3.7.3t.7-.3l5.65-5.65q.275-.275.275-.7t-.275-.7q-.275-.275-.7-.275t-.7.275L10.6 13.8ZM12 22q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22Z"
				/>
			</symbol>
			<symbol id="material-symbols-arrow-back-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="gg-calendar-today" viewBox="0 0 24 24">
				<g fill="currentColor">
			...
			<symbol id="ion-fitness" viewBox="0 0 512 512">
				<path
					fill="currentColor"
			...
			<symbol id="ion-fitness-outline" viewBox="0 0 512 512">
				<path
					fill="none"
					stroke="currentColor"
			...
			<symbol id="material-symbols-add-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-alarm-outline-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-alarm-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-chevron-left-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-chevron-right-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
					d="M12.6 12L8.7 8.1q-.275-.275-.275-.7t.275-.7q.275-.275.7-.275t.7.275l4.6 4.6q.15.15.213.325t.062.375q0 .2-.063.375t-.212.325l-4.6 4.6q-.275.275-.7.275t-.7-.275q-.275-.275-.275-.7t.275-.7l3.9-3.9Z"
				/>
			</symbol>
			<symbol id="material-symbols-delete-outline-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-keyboard-arrow-down-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-keyboard-arrow-up-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-motion-photos-paused-outline-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-pause-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-play-arrow-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-remove-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
					d="M6 13q-.425 0-.713-.288T5 12q0-.425.288-.713T6 11h12q.425 0 .713.288T19 12q0 .425-.288.713T18 13H6Z"
				/>
			</symbol>
			<symbol id="material-symbols-replay-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-rotate-right-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-skip-next-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-skip-previous-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-stop-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
					d="M6 16V8q0-.825.588-1.413T8 6h8q.825 0 1.413.588T18 8v8q0 .825-.588 1.413T16 18H8q-.825 0-1.413-.588T6 16Z"
				/>
			</symbol>
			<symbol id="material-symbols-timer-outline-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-trending-down-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-trending-flat-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-trending-up-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-exclamation-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
			...
			<symbol id="material-symbols-fitbit-check-small-rounded" viewBox="0 0 24 24">
				<path
					fill="currentColor"
